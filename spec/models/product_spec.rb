...
RSpec.describe Product, type: :model do
  describe 'Validations' do
    it "Should save the new product if all validations pass" do
      ...
      @product = Product.new(name: "Soccer Ball", price_cents: "2400", quantity: 8, category: @category) 
      @product.valid? 
    ...
    it "Should fail to save a new product if name is missing" do
      @category = Category.new(name: "test")
      @product = Product.new(price_cents: "2400", quantity: 8, category: @category) 
      @product.valid? 
    ...
    it "Should fail to save a new product if quantity is missing" do
      @category = Category.new(name: "test")
      @product = Product.new(name: "Soccer Ball", price_cents: "2400", category: @category)  
      @product.valid? 
    ...
    it "Should fail to save a new product if category is missing" do
      @category = Category.new(name: "test")
      @product = Product.new(name: "Soccer Ball", price_cents: "2400", quantity: 8) 
      @product.valid? 
